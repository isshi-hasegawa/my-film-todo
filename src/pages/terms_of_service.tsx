  ...
  return (
    <>
      ...
      <Box placeItems="center" px="5rem" py="72px">
        ...
        <OrderedList>
          <ListItem>
            ...
            <OrderedList>
              ...
              <ListItem>その他、本サービスの提供が困難と判断した場合</ListItem>
            </OrderedList>
          </ListItem>
          <ListItem>
            本サービスの提供の停止または中断により、ユーザーまたは第三者が被ったいかなる不利益または損害についても、本サービスは一切の責任を負わないものとします。
          </ListItem>
        </OrderedList>
        <br />
        <Text fontSize="3xl" fontWeight="bold">
        ...
        <OrderedList>
          <ListItem>
            本サービスは、ユーザーが以下のいずれかに該当する場合には、事前の通知なく、ユーザーに対して本サービスの全部もしくは一部の利用を制限しまたはユーザーとしての登録を抹消することができるものとします。
            <OrderedList>
